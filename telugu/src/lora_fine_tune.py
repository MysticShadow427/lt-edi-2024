...
train_df.to_csv('/content/lt-edi-2024/telugu/data/homo_Telugu_train.csv',index = False)
val_df.to_csv('/content/lt-edi-2024/telugu/data/homo_Telugu_dev.csv',index = False)
test_df.to_csv('/content/lt-edi-2024/telugu/data/homo_Telugu_test.csv',index = False)
print('\033[96m' + 'Preprocessed CSV  ready'+ '\033[0m')

train_dataset = load_dataset("csv", data_files='/content/lt-edi-2024/telugu/data/homo_Telugu_train.csv')
val_dataset = load_dataset("csv", data_files='/content/lt-edi-2024/telugu/data/homo_Telugu_dev.csv')
test_dataset = load_dataset("csv", data_files='/content/lt-edi-2024/telugu/data/homo_Telugu_test.csv')
...
print('\033[96m' + 'Loaded pretrained Telugu BERT'+ '\033[0m')
print()
